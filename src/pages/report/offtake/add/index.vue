      ...
      <VCol cols="12" md="6">
        ...
        <VRow class="fixed-new" style="align-items: end;justify-content: end;">
          ...
          <VCol cols="8" md="2" style="display: flex;align-items: center;justify-content: center;gap: 5px;">
            ...
            <VBtn v-if="Productlist.id>0 && userData.position_name != 'Assistant Management' && userData.position_name != 'Management'" color="primary" @click="save_offtake_confirm">บันทึก</VBtn>
          </VCol>
        </VRow>
